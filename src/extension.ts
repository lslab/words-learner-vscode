...
export function activate(context: vscode.ExtensionContext) {
  ...
  vscode.workspace.onDidChangeConfiguration(function(event) {
    const configList = ['words-learner.chapterLength'];
  ...
  let startCom = vscode.commands.registerCommand('words-learner.Start', () => {
    isStart = !isStart
    if (isStart) {
      wordBar.show()
      inputBar.show()
  ...
  let changeChapterCom = vscode.commands.registerCommand('words-learner.changeChapter', async () => {
  ...
  let changeDictCom = vscode.commands.registerCommand('words-learner.changeDict', async () => {
